...
const parsePrelease_1 = __nccwpck_require__(7240);
function run() {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (matches || useCurrentVersion) {
                ...
                core.setOutput('prerelease', res.prerelease ? res.prerelease.join('.') : '');
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.parsePrelease = void 0;
const semver_1 = __nccwpck_require__(1383);
const parsePrelease = (semverString, currentVersion) => {
    var _a;
    let parsed = null;
    let preReleaseName = 'alpha.0';
    let preReleaseType = 'alpha';
    if (semverString) {
        parsed = (0, semver_1.parse)(semverString);
        if (parsed && parsed.prerelease && parsed.prerelease.length) {
            preReleaseType = `${parsed.prerelease[0]}`;
            preReleaseName = `${preReleaseType}.${typeof parsed.prerelease[1] === 'number' ? parsed.prerelease[1] : 0}`;
        }
    }
    else if (semverString || currentVersion) {
        parsed = (0, semver_1.parse)(currentVersion);
        if (parsed && parsed.prerelease && parsed.prerelease.length) {
            preReleaseType = `${parsed.prerelease[0]}`;
            preReleaseName = `${preReleaseType}.${typeof parsed.prerelease[1] === 'number' ? parsed.prerelease[1] + 1 : 0}`;
        }
    }
    return {
        full: (_a = parsed === null || parsed === void 0 ? void 0 : parsed.raw) !== null && _a !== void 0 ? _a : '',
...
exports.parsePrelease = parsePrelease;
